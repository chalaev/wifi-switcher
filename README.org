...
* Quick start
Download (or create yourself using ~pack.sh~) and install [[https://github.com/chalaev/chalaev/raw/master/pub/ws/wifi-switcher_2.0-2_all.deb][wifi-switcher_last_all.deb]]
#+BEGIN_SRC sh
