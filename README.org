...
* Quick start
Download (or create yourself using ~pack.sh~) and install [[https://raw.githubusercontent.com/chalaev/wifi-switcher/package/master/wifi-switcher_2.0-1_all.deb][wifi-switcher_2.0-1_all.deb]]
#+BEGIN_SRC sh
