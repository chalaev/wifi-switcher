...
* Quick start
Download (or create yourself using ~pack.sh~) and install [[https://github.com/chalaev/chalaev/raw/master/pub/ws/wifi-switcher_2.0-1_all.deb][wifi-switcher_2.0-1_all.deb]]
#+BEGIN_SRC sh
